    ...
    .directive('mentio', ['mentioUtil', '$document', '$compile', '$log', '$timeout',
        function(mentioUtil, $document, $compile, $log, $timeout) {
            return {
                ...
                controller: ["$scope", "$timeout", "$attrs", "$element",

                    function($scope, $timeout, $attrs, $element) {
                ...
                link: function(scope, element, attrs) {
                    ...
                    scope.$watch(
                        ...
                        function(newValue) {
                            ...
                            // var text = scope.targetElement.contents().filter(function() {
...
.directive('mentioMenuItem', function($compile) {
    return {
        restrict: 'A',
        scope: {
            item: '=mentioMenuItem'
